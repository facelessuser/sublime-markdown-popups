...
from ..lexer import bygroups, default, include, inherit
from ..lexers.javascript import JavascriptLexer, TypeScriptLexer
from ..token import Name, Operator, Punctuation, String, Text, \
    Whitespace
