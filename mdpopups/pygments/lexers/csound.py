...
from ..token import Comment, Error, Keyword, Name, Number, Operator, Punctuation, \
    String, Text, Whitespace
from ..lexers._csound_builtins import OPCODES, DEPRECATED_OPCODES, REMOVED_OPCODES
from ..lexers.html import HtmlLexer
from ..lexers.python import PythonLexer
from ..lexers.scripting import LuaLexer
