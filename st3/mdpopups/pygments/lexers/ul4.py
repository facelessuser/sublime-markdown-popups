...
from ..lexer import RegexLexer, DelegatingLexer, bygroups, words, include
from ..token import Comment, Text, Keyword, String, Number, Literal, \
    Name, Other, Operator
from ..lexers.web import HtmlLexer, XmlLexer, CssLexer, JavascriptLexer
